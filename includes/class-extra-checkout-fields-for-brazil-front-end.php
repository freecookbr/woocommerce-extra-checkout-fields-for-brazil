...
// Load CNPJ.ws API service.
require_once plugin_dir_path( dirname( __FILE__ ) ) . 'services/cnpj_biz/class-cnpj-biz-api.php';
...
class Extra_Checkout_Fields_For_Brazil_Front_End {
	...
	public function __construct() {
		...
		// CNPJ.ws API lookup via AJAX.
		Extra_Checkout_Fields_For_Brazil_Cnpj_Biz_Api::register_ajax_actions();
	}
	...
	public function enqueue_scripts() {
		...
		wp_localize_script(
			...
			array(
				...
				'cnpj_nonce'       => wp_create_nonce( 'wcbcf_cnpj_lookup_nonce' ),
				/* translators: CNPJ lookup error message */
				'cnpj_error'       => esc_js( __( 'Could not retrieve CNPJ data. Please fill in the fields manually.', 'woocommerce-extra-checkout-fields-for-brazil' ) ),
				'cnpj_not_found'   => esc_js( __( 'CNPJ not found.', 'woocommerce-extra-checkout-fields-for-brazil' ) ),
				'cnpj_loading'     => esc_js( __( 'Searching CNPJ...', 'woocommerce-extra-checkout-fields-for-brazil' ) ),
			)
		);
	}
